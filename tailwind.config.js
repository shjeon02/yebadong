...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary Colors - Progressive Rock inspired
        primary: {
          50: '#eef2ff',
          100: '#e0e7ff',
          200: '#c7d2fe',
        ...
        'metal-red': '#dc2626',
        'ambient-cyan': '#06b6d4',
        'experimental-purple': '#7c3aed',
        'classic-yellow': '#eab308',
      },
      fontFamily: {
      ...
      backgroundImage: {
        ...
        'hero-pattern': 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #020617 100%)',
        'vinyl-pattern': 'url("/images/vinyl-pattern.svg")',
      },
      boxShadow: {
