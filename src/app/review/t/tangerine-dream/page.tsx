...
온라인으로 쓴글이라 두서가 다소 없음을 이해하시고...(처음으로 올린글이니 이쁘게 봐주셔요..^^)..텐저린의 음반중에서 이색적인 이 음반을 기회가 나시면 들어보셨으면 합니다. 개인적으로 ricochet과 함께 가장 좋아하는 이들의 앨범이랍니다.`
    },
    {
      ...
      email: "577102@hitel.net",
      date: "93.10",
      content: `Tangerine Dream [TYGER] (1987)

1. Tyger (5:09)
2. London (14:21)
3. Alchemy of the heart (12:01)
4. Smile (5:54)
5. 21st century common man (part1) (4:48)
6. 21st century common man (part2) (3:57)
7. Vigour (4:56)
...
그동안 이 음반을 구하기 위해 무척 많이 돌아다녔지만 구하지 못하다가 이번에 힘들게 구입하게 되었습니다. 

T.D는 이 음반이후에 보다 더 대중적인 사운드로 변모되었는데 이 이후의 음반은 이번에 라이센스로 나온 BEST음반을 구입하시면 88년부터 최근까지의 그들의 음악을 이해하시는데 큰 도움이 되리라 생각합니다.

총 7곡이 수록되어 있는 tyger의 자켓은 에드가의 아내 Monica froese가 맡았는데 앨범 타이틀에 걸맞게 호랑이 얼굴반쪽이 아주 세밀하게 그려져 있습니다.

첫번째곡 tyger는 잘 아시겠지만 William Blake의 시를 노래로 불려주고 있는데 전자음과 Jocelyn B ernadette Smith의 매력적인 보컬이 이상하리만큼 잘 어울리는 인상적인 곡입니다.

2번째곡 London은 이 음반에서는 제일 긴 곡으로 80년대 그들의 변모된 사운드위에 보컬이 가미되서 들려주고 있는데 앞의 tyger와 비슷한 분위기의 연주이지만 곡이 길어서 그런지 후반부에 가서는 그들 특유의 짜임새 있는 연주가 돋보입니다.

3번째곡 Alchemy of the heart는 설명히 필요없는 곡으로서 그들의 80년에 발표된 음반 가운데에서는 몇 안되는 뛰어난 곡 가운데에서 백미가 아닌가 하는 생각이 들 정도로 12분동안 듣는이를 압도하는 매력적인 곡입니다.

방송을 통해서 많이 소개된 곡이니까 자세한 설명은 생략하겠습니다.

4번째곡과 5번째곡은 연결된 곡으로 제목만 봐서는 얼핏 킹크림슨의 대표곡 21st century schizoid man을 연상시키는데 두곡모두 그리 뛰어나지는 않지만 들어볼만한 가치는 충분히 있는 곡이라고 말하고 싶습니다.

마지막곡 역시 마찬가지구요.

전체적으로 봤을때 이 음반은 특정곡 뿐만 아니라 나머지곡 역시 음악적인 완성도가 80년대 들어와서 발표된 음반들 가운데에서는 무척 깊은 인상을 심어주었던 걸작이라고 말씀드리고 싶고 T.D에 진정 관심있는 분들이라면 놓치지 말아야 할 음반이라는 점 또한 강조드리고 싶습니다.`
    }
  ];
