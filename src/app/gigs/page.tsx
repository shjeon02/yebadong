...
export default function GigsPage() {
  const gigs = [
    { t: "John Cage", f: "/gigs/johncage" },
    { t: "Deep Purple (Seoul, '95.3.20)", f: "/gigs/purple" },
    { t: "FreeSpirits", f: "/gigs/freespirits" },
    { t: "Guitar Trio (예술의전당, '97.2.25)", f: "/gigs/guitartrio" },
    { t: "Kronos Quartet (예술의전당, '96.5.31)", f: "/gigs/kronosqt" },
    { t: "Pat Metheny (세종문화회관, '95.10.05)", f: "/gigs/patmetheny" },
    { t: "Steve Vai (KBS 88 체육관, '97.2.19)", f: "/gigs/stevevai" },
    { t: "ToTo (올림픽공원, '96.4.17)", f: "/gigs/toto" },
    { t: "Meredith Monk (서울대 강당, '97.10.9-10)", f: "/gigs/meredith" },
    { t: "'99 Triport Song Do Rock Festival (송도해수욕장, '99.7.31)", f: "/gigs/triport99" },
    { t: "Dream Theater 2000 METROPOLIS Tour (올림픽 테니스 경기장, '00.5.6)", f: "/gigs/dt2000" },
